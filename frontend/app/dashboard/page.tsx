        ...
        {predictions && (
          <div className="mt-4 grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="bg-slate-800 rounded-lg p-4">
              ...
              <p className="text-2xl font-bold text-white">{predictions.total_games}</p>
            </div>
            <div className="bg-slate-800 rounded-lg p-4">
              <p className="text-slate-400 text-sm">BET</p>
              <p className="text-2xl font-bold text-emerald-400">{predictions.bet_count}</p>
            </div>
            <div className="bg-slate-800 rounded-lg p-4">
              <p className="text-slate-400 text-sm">LEAN</p>
              <p className="text-2xl font-bold text-amber-400">{predictions.lean_count}</p>
            </div>
            <div className="bg-slate-800 rounded-lg p-4">
              <p className="text-slate-400 text-sm">PASS</p>
              <p className="text-2xl font-bold text-slate-400">{predictions.pass_count}</p>
            </div>
          </div>
        )}
